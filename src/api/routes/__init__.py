...
Used by: src.api.app
Dependencies: src.api.routes.media, src.api.routes.thumbnails, src.api.routes.stream, src.api.routes.folders
Public Members: media_router, thumbnail_router, stream_router, folders_router
Side Effects: None
=============================================================================
"""
...
__all__ = ["media_router", "thumbnail_router", "stream_router", "folders_router"]
