...
export const VideoPlayer: React.FC<VideoPlayerProps> = ({ item }) => {
  ...
  return (
    <div
      ...
      className="relative w-full h-full max-h-[85vh] flex items-center justify-center bg-black/95 rounded-2xl overflow-hidden shadow-2xl select-none group"
    >
      {/* Video Element */}
      <video
        ref={videoRef}
